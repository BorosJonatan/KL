...
function showHead()
{
    ...
    <body>
        ...
        <a href="?class=student_averages"><button type="button">Student averages</button></a>   
        <a href="?class=worstbest"><button type="button">Legjobb-legrosszabb osztályok</button></a>
...
function showAverageSchoolSave(){
    ...
    <button type="submit" name="save" value="school_average">Mentés</button>
    </form>';
}

function showAverageClassSave(){
    echo '<form method="POST"><input hidden="true" name="query" value="class_averages"><button name="save" type="submit" value="class_average">Mentés</button></form>';
}

//ranking save buttons
function showRankingSchoolSave(){
    echo '<form method="POST"><input hidden="true" name="query" value="school_rankings"><button name="save" type="submit" value="school_ranking">Mentés</button></form>';
}

function showRankingClassSave(){
    echo '<form method="POST"><input hidden="true" name="query" value="class_rankings"><button name="save" type="submit" value="class_ranking">Mentés</button></form>';
}

//student averages save button
function showStudentAveragesSave(){
    echo '<form method="POST"><button id="save" type="submit" name="studentAveragesSave">Mentés</button><form>';
}
